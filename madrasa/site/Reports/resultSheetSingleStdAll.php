  ...
  <table width="1117" align="center" border="0" cellpadding="0" cellspacing="0" bgcolor="#006633" height="100">
    <tr>
      ...
      <table align="center" border="0" cellpadding="0" cellspacing="0" style="font-size:20px;">
        <tr>
            <td width="67" style="vertical-align:middle; line-height:1px !important"><font color="#FFFFFF"> درجہ  </font></td>
            ...
            <td width="130"> 
                ...
                <td width="79" style="vertical-align:middle; line-height:1px !important"><font color="#FFFFFF"> طالب علم </font> </td>
		...
		isset($_REQUEST['regSno']) && !empty($_REQUEST['regSno'])) {
			...
			if($crud->search($sqlRstSearch)) { ?>
                    <table width="1117" border="0" align="center">
                      <tr>
                        <td width="364"><h2><?php echo(M_Name); ?></h2>
                        <font style="font-size:20px;"><?php echo(L_Address); ?></font>
                        </td>
                        <td width="287" align="center"><h2>مکتب نتائج الاختبارات
                        <hr style="border-style:solid; height:1px;" />
                        المرحلۃ <?php if(isset($_REQUEST['darja'])) { echo($crud->getValue("SELECT darja FROM darjaat WHERE derjaCode = ".$_REQUEST['darja'],"darja")); } ?> العامہ
                        </h2>
                        </td>
                        ...
                        <table width="1117" border="1" align="center" cellspacing="0" cellpadding="0">
                          <tr>
                            <td width="19" style="vertical-align:middle; text-align:center;"><font size="3">الرقم</font></td>
                            <td width="46" nowrap="nowrap" style="vertical-align:middle; text-align:center;"><font size="3" style="font-family:'Jameel Noori Nastaleeq'; line-height:20px;">اسم طالب <br />مع ولدیت</font></td>
                            <td width="63" style="vertical-align:middle; text-align:center; font-weight:bold;"><font size="3">سالانہ<br /> نتائج</font></td>
                                    ...
                                    <table border="1" cellspacing="0" cellpadding="0" width="250">
                                         <?php   //to fetch all the subjects in the specified darja in table below
                                            ...
                                            if($crud->search($subjectSql)) {
                                                ...
                                                ?>
                                                <tr>
                                                    <td align="center" <?php if($colspan > 1){ echo(" colspan='".$colspan."'")	; } ?>> مضامین </td>
                                                </tr>
                                                <tr>
                                                    <?php echo($strSubject); ?>
                                                </tr>
                            ...
                            <td width="38" style="text-align:center; vertical-align:middle;"><font size="3">مجموع الدرجات</font></td>
                            <td width="41" style="text-align:center; vertical-align:middle;"><font size="3">الدرجات المحصلۃ</font></td>
                            <td width="38" style="text-align:center; vertical-align:middle;"><font size="3">الاوسط</font></td>
                            <td width="38" style="text-align:center; vertical-align:middle"><font size="3">التقدیر</font></td>
                            <!--<td width="40" style="text-align:center; vertical-align:middle;"><font size="3">الکیفیت</font></td>-->
                            <td width="59" style="text-align:center; vertical-align:middle;"><font size="3">کشف الحضور</font></td>
			...
			if($crud->search($resultAllSql)){
 			 ...
 			 ?>      
              <tr>
                <td width="19"><font size="3"> <?php echo($sno); ?> </font></td>
                <td width="46"><font size="3" style="font-family:'Jameel Noori Nastaleeq'; line-height:17px;">
